...
"$cc" -I"$root/include" "$root/tests/beui-test.c" \
	"$build_dir/libnoctapi.a" "$build_dir/libnoct.a" -lm \
	-o "$build_dir/noct-beui-test"
"$build_dir/noct-beui-test"

"$cc" -I"$root/include" -I"$api" "$root/tests/beui-pc98-gdc-test.c" \
...
"$cc" -I"$root/include" -I"$api" "$root/tests/beui-pc98-cirrus-test.c" \
