...
"$cc" -I"$root/include" "$root/tests/jit-slab-test.c" \
...
"$build_dir/noct" -O3 --jit-code-size=28672 \
	"$root/tests/simd/blend2.noct" > "$build_dir/jit-slab-blend.out"
diff "$root/tests/simd/blend2.noct.out" "$build_dir/jit-slab-blend.out"
