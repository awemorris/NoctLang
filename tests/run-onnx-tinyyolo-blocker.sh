...
NOCT=${NOCT:-$ROOT/build-stage-c/noct}
...
INPUT="$ROOT/tests/onnx2noct/oracle-data/tinyyolov2-8.input.f32le"
EXPECTED="$ROOT/tests/onnx2noct/oracle-data/tinyyolov2-8.output.f32le"
TMP=$(mktemp -d)
...
python3 "$ROOT/tests/onnx2noct/verify-locked-model.py" \
	"$ROOT/tests/dnn/models.lock" tinyyolov2-8 "$MODEL" >/dev/null
