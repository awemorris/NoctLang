...
CATALOG: list[dict[str, Any]] = [
    ...
    },
    {
        ...
        "source": {
            "kind": "repository",
            "path": "tests/onnx2noct/fixtures/models/project-cifar-opset12.onnx",
            "generator": "tests/onnx2noct/oracle/generate_fixtures.py",
...
def main() -> None:
    ...
    for catalog in CATALOG:
        ...
        models.append({
            ...
            "oracle": {
                "lock": "tests/onnx2noct/oracle-data/model-oracles.lock",
                "input": oracle["input"],
    ...
    lock = {
        ...
        "generated_by": "tests/onnx2noct/oracle/build_models_lock.py",
        "models": models,
    }
