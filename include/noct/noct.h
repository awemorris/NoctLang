 ...
 *  - This file contains absolute contracts.
 *  - You cannot add, remove, or edit the contracts.
 */
...
struct rt_config {
	...
	/*
	 * "require" resolver. (NULL-able)
	 * Returns a strdup()-ed string of a file path for a specified module.
	 */
