 ...
 * within src/api and their direct unit tests.  Installed callers use
 * <noct/beui.h>, which exposes only noct_register_api_beui().
 */

#ifndef NOCT_BEUI_INTERNAL_H
#define NOCT_BEUI_INTERNAL_H
