 ...
 *
 * File.* owns this private copy so that the platform API implementation is
 * self-contained. Zero denotes an unassigned cell.
 */
static const uint16_t fileutil_jisx0208_to_ucs[7896] = {
